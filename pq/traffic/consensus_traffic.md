...
-   **Total Soft Votes Seen (Avg):** 305 (on-time) + 324 (late) = **629** messages, representing ≈469 unique soft senders (≈344 on-time + ≈125 late-only), which is close to the theoretical 354 once late arrivals are deduplicated.
